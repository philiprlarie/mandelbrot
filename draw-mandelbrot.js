$('#mandelbrot-input').submit(function (e) {
  ...
  var opts = {
    ...
    numBands: 5,
    bandSplitPercents: [0.2, 0.45, 0.78, 0.97],
    startColors: [
      [0, 0, 0, 255],
      [255, 0, 0, 255],
      [0, 255, 0, 255],
...
// sorted array of iterations
// select different bands, width of bands, starting ending color for each band
// assign percent values for each iteration value based on it's band value
// map pixel iteration value to color
